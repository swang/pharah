...
var fetchBase64 = createCommonjsModule(function (module, exports) {
(function (global, factory) {
  if (typeof undefined === "function" && undefined.amd) {
    undefined('fetchBase64', ['module', 'exports'], factory);
  } else {
...
var mp3s = ['Pharah_-_Defend_The_Point,_Strike_As_One.mp3', 'Pharah_-_I\'m_Impressed.mp3', 'Pharah_-_I\'m_Taking_The_Objective,_Converge_On_Me.mp3', 'Pharah_-_I_Always_Get_My_Prey.mp3', 'Pharah_-_Impressed.mp3', 'Pharah_-_Let\'s_Keep_The_Payload_Moving.mp3', 'Pharah_-_My_Ultimate_Is_Ready.mp3', 'Pharah_-_Remember_Your_Training,_And_We\'ll_Get_Through_This_Just_Fine.mp3', 'Pharah_-_Tango,_Down.mp3'];
var url = 'Pharah_-_Impressed.mp3';
var de = document.getElementById.bind(document);
var f = new FetchBase64();

var cacheAudio = function cacheAudio(url) {
  return new Promise(function (resolve, reject) {
    if (cache[url]) {
      resolve(cache[url]);
    } else {
      f.fetch(githubUrl + 'mp3/' + url, { mode: 'no-cors' }).then(function (base64) {
        cache[url] = base64;
        resolve(base64);
      }).catch(function (err) {
...
var cacheMedia = function cacheMedia(url) {
  ...
  if (imgCache[icon]) {
    ...
    f.fetchAsData(githubUrl + icon).then(function (dataUri) {
...
de('pharah').addEventListener('click', function () {
  ...
  var url = mp3s[~~(Math.random() * mp3s.length)];
  cacheAudio(url).then(function (base64) {
